...
export function DreamyPinkTemplate({ surprise, onEvent }: TemplateProps) {
  ...
  const accent = surprise.accentColor || TOKENS.rose;
      ...
      <AnimatePresence mode="wait">
        {scene === "intro" && (
          ...
          >
            ...
            <button
              ...
              style={{
                background: `linear-gradient(135deg, ${accent}, ${TOKENS.roseDeep})`,
              }}
            >
              Open My Surprise 🎁
            </button>
        ...
        {scene === "final" && (
          ...
          >
            ...
            {surprise.insideJoke && (
              <p className="mt-2 text-xs" style={{ color: TOKENS.mauve }}>
